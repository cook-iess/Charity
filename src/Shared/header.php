...
?>
  ...
  <body>
    <header id="header" class="p-2 pr-6 py-3 flex justify-between items-center text-gray-800 fixed w-full z-20 transition-all duration-300 bg-transparent">
      ...
      <nav class="flex flex-grow justify-center space-x-8 text-lg text-sky-900">
      ...
      <div class="flex space-x-4">
        <div class="relative">
          <button id="notificationButton" class="notification-icon relative">
            <i class="fas fa-bell text-2xl" style="color: #FFD700 !important;"></i>
